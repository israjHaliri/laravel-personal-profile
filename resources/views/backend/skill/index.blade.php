...
<div class="col-md-12" align="right">
	{{ Form::open(array('route' => 'backend/skill','method' => 'GET')) }}
		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-6" align="right">
					<a href="{{ route('backend/skill/create') }}" style="margin-bottom: 0px;" class="btn btn-xs btn-primary"><em class="fa fa-plus"></em>&nbsp;Add</a>
				</div>
			</div>
		</div>
				...
				<table class="table table-bordered table-striped table-responsive">
					...
					<tbody>
						...
						<tr>					
							...
							<td align="center">
								<a class="btn btn-success" href="{{ route('backend/skill/edit', $data->id) }}"><em class="fa fa-pencil"></em></a>
								<a class="btn btn-danger" href="{{ route('backend/skill/delete', $data->id) }}"><em class="fa fa-trash"></em></a>
							</td>
						</tr>
						@endforeach
					</tbody>
