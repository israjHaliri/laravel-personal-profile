...
<head>
	...
	<link href="{{ asset('resources/assets/css/rangeslider.css') }}" rel="stylesheet">
...
<body class="skin-dark">
	...
	<script src="{{ asset('resources/assets/js/rangeslider.js') }}"></script>
	<script src="{{ asset('resources/assets/js/backend/main.js') }}"></script>
	<script src="{{ asset('resources/assets/js/backend/custom_range.js') }}"></script>
